# [React Soft Flask](https://app-generator.dev/product/soft-ui-dashboard/api-flask/react/)

Full-Stack Seed starter provided by **[App Generator](https://app-generator.dev/)** on top of **[Soft Ui Dashboard](https://app-generator.dev/product/soft-ui-dashboard/)** design. The backend logic is provided by a simple, `easy-to-extend` API Server that manages the Authentication flow (login, registration, logout) using `JSON Web Tokens` (JWT).

- 👉 [React Soft Flask](https://app-generator.dev/product/soft-ui-dashboard/api-flask/react/) - `Product page`
...
## [React Soft UI Dashboard PRO](https://app-generator.dev/product/soft-ui-dashboard-pro/fullstack/react/)
...
- 👉 [React Soft UI Dashboard PRO](https://app-generator.dev/product/soft-ui-dashboard-pro/fullstack/react/) - Product Page
...
---
[React Soft Flask](https://app-generator.dev/product/soft-ui-dashboard/api-flask/react/) - Full-Stack starter generated by **[App Generator](https://app-generator.dev/)**.
